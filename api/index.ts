...
<body>
  <header><div class="container"><div class="logo">🚇🚌🚲</div><h1>Korea Transit MCP</h1><p class="tagline">"강남역 지하철 언제 와?" 라고 물으면 바로 답해드립니다</p><div class="badges"><a href="https://playmcp.kakao.com" class="badge" target="_blank">PlayMCP 등록</a><a href="https://github.com/heisenbug0306-tech/korea_transit_mcp" class="badge" target="_blank">GitHub</a><span class="badge">MCP Compatible</span><span class="badge">실시간 데이터</span></div></div></header>
...
2. 신분당선 - 신사행
  ...
  <section class="cta"><div class="container"><h2>지금 바로 사용해보세요</h2><p>PlayMCP에서 도구함에 추가하거나 Claude Desktop에 연결하세요</p><div class="cta-buttons"><a href="https://playmcp.kakao.com" class="btn btn-primary" target="_blank">PlayMCP에서 추가</a><a href="https://github.com/heisenbug0306-tech/korea_transit_mcp" class="btn btn-secondary" target="_blank">GitHub 저장소</a></div></div></section>
  <footer><div class="container"><p><strong>Korea Transit MCP</strong> - 서울 대중교통, AI에게 물어보세요</p><div class="endpoint">MCP Endpoint: https://korea-transit-mcp.vercel.app/mcp</div><p style="margin-top:20px"><a href="https://github.com/heisenbug0306-tech/korea_transit_mcp">GitHub</a> · <a href="https://playmcp.kakao.com">PlayMCP</a> · MIT License</p></div></footer>
</body>
</html>`;
